<h2 class="sub-header">Data Pasien <small>or</small> <a href="?ur=tambah_pasien" class="btn btn-primary">Tambah Data</a></h2>
...
<table class="table table-hover">
  ...
  <tbody>
	<?php
		$dataPeserta = new db;
		$num=1;
		$dataPeserta->BuatQuery("SELECT *, YEAR(CURRENT_DATE()) - YEAR(tanggal_lahir) AS Usia FROM pasien");
