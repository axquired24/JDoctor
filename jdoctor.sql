...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2015 at 05:25 AM
...
--
ALTER TABLE `obat`
  MODIFY `id_obat` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=406;
--
...
--
ALTER TABLE `riwayat`
  MODIFY `id_riwayat` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=609;
